...
import resultados_img from '../../assets/resultados.png';
        ...
        <div id="home-content">
            ...
            <section>
                ...
                <div className='ligas-internas'>
                    <Card className="home-card" img={resultados_img} description={"Consulta de enceuntros Ligas Internas"}/>
                    <Card className="home-card"  img={resultados_img} description={"Consulta de clasificaciones Ligas Internas"} />
                </div>
